...
Route::resource(
    'buyers', //nombre
    BuyerController::class, //controlador
    ['only' => ['index' , 'show']] //se limita a que el path buyers solo tenga acceso a index y show
);

Route::resource('buyers.transactions', BuyerTransactionController::class, ['only' => ['index']]);//excepto
 ...
 * Categories
 */
Route::resource('categories', CategoryController::class, ['except' => ['create', 'edit']]);//excepto
